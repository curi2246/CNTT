document.addEventListener("DOMContentLoaded", () => {
    ...
    function syncDataFromHTML() {
        const dataStore = {
            ...
            "The enemy": {
                "enemies.txt": "여태까지 큐로, 키스네, 리에가 상대하던 적들, 혹은 적 이였던 존재들을 나열한 파일이다. 각각 애키스(ekis), 키스네 코든(kisune_corden), 알레프(aleph)가 있다. 그들이 상대, 혹은 겪었던 현상과 자연재해들은 전부 World 파일에 있으니 참고.",
                "Ekis_Full_Archive.txt": "명칭: 애키스(Ekis)\n\n[종족]\n???\n\n[성별]\n\n[프로필]\n키: 190cm\n몸무게: 84kg\n성격: 어디로 튈지 모르는 미치광이 싸이코 패스 뭐든 실험에 일종이라고 하며 정당화시키고 비인류적인 것들조차 감미롭게 보는 미친놈",
                "Kisune_corden_Full_Archive.txt": "더미 데이터",
